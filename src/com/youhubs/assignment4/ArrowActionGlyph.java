...
/**
 * An instance of the {@link ActionGlyphPainter} that will render arrows to the
 * graphics context.
 * 
...
public class ArrowActionGlyph implements ActionGlyphPainter {
	 ...
	 * respectively, belong to the class classWithPositionAtts, and the north,
	 * south east, west actions have the corresponding names and will be
	 * rendered using
	 * {@link burlap.behavior.singleagent.auxiliary.valuefunctionvis.common.ArrowActionGlyph}
	 * objects.
	 * 
	 * @param classWithPositionAtts
	 *            the class which contains the x-y position information of the
	 *            state.
	 * @param xAtt
	 *            the name of the x attribute
	 * @param yAtt
	 *            the name of the y attribute
	 * @param northActionName
	 *            the name of the north action
	 * @param southActionName
	 *            the name of the south action
	 * @param eastActionName
	 *            the name of the east action
	 * @param westActionName
	 *            the name of the west action
	 * @return a
	 *         {@link burlap.behavior.singleagent.auxiliary.valuefunctionvis.common.PolicyGlyphPainter2D}
	 *         instance.
	 */
	public static PolicyGlyphPainter2D getNSEWPolicyGlyphPainter(
			String classWithPositionAtts, String xAtt, String yAtt,
			String northActionName, String southActionName,
			String eastActionName, String westActionName) {
	...
	public void paintGlyph(Graphics2D g2, float x, float y, float width, float height) {
		...
		BufferedImage glyphImage = new BufferedImage((int) width, (int) width,
		...
		int[] xTriangle = new int[] { (int) (cx - arrowHeadWidth), (int) cx,
				(int) (cx + arrowHeadWidth) };
