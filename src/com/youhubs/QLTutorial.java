...
public class QLTutorial extends MDPSolver implements LearningAgent, QFunction {
	...
	public EpisodeAnalysis runLearningEpisode(Environment env, int maxSteps) {
		// initialize our episode analysis object with the initial state of the
		// environment
		...
		while (!env.isInTerminalState() && (steps < maxSteps || maxSteps == -1)) {
			...
			// select an action
			GroundedAction a = (GroundedAction) this.learningPolicy
					.getAction(curState);
	...
	public static void main(String[] args) {
		...
		// create Q-learning
		QLTutorial agent = new QLTutorial(
				domain,
				0.99,
